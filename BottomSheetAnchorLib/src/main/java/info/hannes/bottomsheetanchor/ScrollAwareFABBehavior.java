...
public class ScrollAwareFABBehavior extends FloatingActionButton.Behavior {
    ...
    /**
     * The FAB should be hidden when it reach {@link #offset} or when {@link BottomSheetAnchorBehavior}
     * is visually lower than {@link BottomSheetAnchorBehavior#getPeekHeight()}.
...
//         Ensure we react to vertical scrolling
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        ...
        if ((child.getY() + DyFix) < offset) {
            ...
            /*
              We are calculating every time point in Y where BottomSheet get {@link BottomSheetAnchorBehavior#STATE_COLLAPSED}.
